...
public class Image_agent : Agent
{
    ...
    void Awake()
    {
        ...
        folderPath = Path.Combine(Application.persistentDataPath, "image_F");
        ...
        filePath = Path.Combine(folderPath, "Image_data.csv");
    ...
    void capture_def()
    {
        string imageName = $"image_{filenumber:D7}";
